...
function theme_enqueue_styles() {
    ...
    wp_enqueue_style( 'swiper-style', get_stylesheet_directory_uri() . '../../../../node_modules/swiper/swiper.min.css');
...
function animations_script() {
    ...
    wp_enqueue_script( 'swiper-script', get_stylesheet_directory_uri() . '../../../../node_modules/swiper/swiper-bundle.min.js', array( 'jquery' ),'',true   );
